/*9.	Ingresar el tiempo trabajado por un operario y considerando que el valor de la hora es de  10 pesos, calcular su sueld e imprimirlo*/
...
int main(){
	...
	printf("calculador de sueldos de empleados (valor por hora $10) \n\n");	 						//instruccion que muestra al usuario para que sirve el programa
	
	//corresponde al paso 2 del diagrama  			
	valor_hora=10;																//se asigna el valor 10 a la variable "valor_hora"
	printf("\n");
	
	
	//corresponde al paso 3 del diagrama
	printf("Ingrese tiempo trabajado por 'un operario en (hs)': ");				//muestra al usuario lo que tiene que introducir por pantalla
	scanf("%i",&hs_t);															//el valor introducido por el usuario el almacenado en la variable asignada en este caso "valor_hora"
	printf("\n");
